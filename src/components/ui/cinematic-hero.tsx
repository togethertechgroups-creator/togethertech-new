...
export function CinematicHero({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        .to(".hero-text-wrapper", { scale: 1.15, autoAlpha: 0, ease: "power2.inOut", duration: 2 }, 0)
        .to(".bg-grid-theme", { scale: 1.15, opacity: 0.2, ease: "power2.inOut", duration: 2 }, 0)
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <div className="text-track gsap-reveal relative inline-block px-12 py-6">
          ...
          <RisingGlow
            ...
            height={180}
            particleCount={25}
            particleColor="#EF8E01"
            className="absolute inset-0 pointer-events-none z-0"
          />
          <h1 className="text-3d-matte text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight mb-2 font-neogen relative z-10">
            {tagline1}
          </h1>
        </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              <h3 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold mb-0 lg:mb-5 tracking-tight font-eternalo">
                {cardHeading}
              </h3>
              {/* HIDDEN ON MOBILE (added hidden md:block) */}
              <p className="hidden md:block text-blue-100/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none font-biooris">
                {cardDescription}
              </p>
            </div>
