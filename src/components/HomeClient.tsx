      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden bg-white pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 text-left space-y-6 bg-white/75 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-slate-100/50 lg:bg-transparent lg:backdrop-blur-none lg:p-0 lg:border-none relative z-10">
              <motion.div
      ...
      <section className="py-24 bg-slate-50 text-brandDark">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl text-brandDark font-mitshuka">Services We Offer</h2>
      ...
      <section className="py-24 bg-white text-brandDark relative overflow-hidden border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-mitshuka">Why Partner With Us?</h2>
            <p className="text-brandGray font-medium">We deliver enterprise-quality execution at prices designed for growing business ecosystems.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl text-brandDark font-mitshuka">Recent Projects</h2>
            </div>
      ...
      <section className="py-24 bg-white text-brandDark relative border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl text-brandDark font-mitshuka">Our Development Packages</h2>
            <p className="text-brandGray font-medium">Select a predefined structure or contact us for a customized development plan.</p>
          </div>
      ...
      <section className="py-24 bg-slate-50 text-brandDark border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-brandGray font-medium">A group of young, highly-skilled professionals turning concepts into software.</p>
          </div>
