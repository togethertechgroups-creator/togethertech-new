...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.togethertechgroups.in/portfolio' },
  openGraph: {
    title: 'Portfolio | Together Tech — Web, App & Software Projects',
    ...
    url: 'https://www.togethertechgroups.in/portfolio',
    siteName: 'Together Tech',
    locale: 'en_IN',
    type: 'website',
    images: [{ url: 'https://www.togethertechgroups.in/images/og-image.jpg', width: 1200, height: 630, alt: 'Together Tech Portfolio' }],
  },
  twitter: {
